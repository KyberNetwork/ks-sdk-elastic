...
export declare abstract class NonfungiblePositionManager {
    ...
    static addCallParameters(position: Position, ticksPrevious: number[], options: AddLiquidityOptions): MethodParameters;
    static addCallParametersUnuse(position: Position, options: AddLiquidityOptions): MethodParameters;
